...
import com.huasoft.common.CachedCommon;
...
public class MemcacheCache implements Cache {
	...
	private String getCacheKey(Object key) {
		if (null == key) {
			...
			return CachedCommon.CACHED_TOKEN_KEY + (String) key;
		} else {
			return CachedCommon.CACHED_TOKEN_KEY + key.toString();
		}
	}
