...
public class CachedCommon {
	 ...
	 * XCPAPI缓存的名称.
	 */
	public static final int CACHED_MINTER_30D = 43200 * 60;
	public static final int CACHED_MINTER_7D = 10080 * 60;
	public static final int CACHED_MINTER_1D = 1440 * 60;
	public static final int CACHED_MINTER_12H = 720 * 60;
	...
	public static final int CACHED_MINTER_20M = 20 * 60;
	public static final int CACHED_MINTER_5M = 5 * 60;
	public static final int CACHED_MINTER_1M = 1 * 60;

	public static final String CACHED_PRE = "tqcapi_";// 所有缓存key的前缀
	...
	public static final String CACHED_CHILD_VEHICLE = "child_vehicle_";//学生的乘坐车辆
	...
	public static final String CACHED_HISTORY = "history_msg_"; //学生历史消息
	
	public static final String CACHED_AUTH = "has_auth_";//已授权用户
	public static final String CACHED_AUTH_TO = "to_auth_";//即将授权用户
